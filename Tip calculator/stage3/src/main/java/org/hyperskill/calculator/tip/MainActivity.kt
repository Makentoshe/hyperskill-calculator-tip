...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        slider.addOnChangeListener { _, percentage, _ ->
            val value = edit_text.text.toString().toDoubleOrNull()
    ...
    private fun display(bill: Double, percentage: Int) {
        text_view.text = getString(R.string.display, bill * percentage / 100)
    }
}